//
//  Camera_ExtensionProvider.swift
//  Camera Extension
//
...
class Camera_ExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	
	private(set) var device: CMIOExtensionDevice!
	
	private var _streamSource: Camera_ExtensionStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = Camera_ExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class Camera_ExtensionStreamSource: NSObject, CMIOExtensionStreamSource {
	...
	func startStream() throws {
		...
		guard let deviceSource = device.source as? Camera_ExtensionDeviceSource else {
...
class Camera_ExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
	
	private(set) var provider: CMIOExtensionProvider!
	
	private var deviceSource: Camera_ExtensionDeviceSource!
	...
	init(clientQueue: DispatchQueue?) {
		...
		deviceSource = Camera_ExtensionDeviceSource(localizedName: "SampleCapture (Swift)")
